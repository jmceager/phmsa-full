...
knitr::opts_knit$set(root.dir = 
                       "~/Library/CloudStorage/OneDrive-pstrust.org/DataViz/R/web_stats")
...
# Gas Pipelines  
```{r echo = FALSE, message = FALSE, warning=FALSE}
df.gd <- read.csv("data/GD_MilesDecadeAge.csv")
df.gt <- read.csv("data/GT_MilesDecadeAge.csv")
df.hl <- read.csv("data/HL_MilesDecadeAge.csv")
```

```{r nice colors, echo = FALSE, message = FALSE, warning=FALSE}
# Get colors
brewer <- brewer.pal(5,"Set1")
red <- brewer[1]
blue <- brewer[2]
green <- brewer[3]
purple <- brewer[4]
...
ggsave("plots/PipelineAgeBar.png", width = 8, height = 6, units = "in")
...
ggsave("plots/PipelineAgeArea.png", width = 8, height = 6, units = "in")
...
ggsave("plots/PipelineAgeDecadeLines.png", width = 8, height = 6, units = "in")
```
...
```{r}
gd.inc <- read_xlsx("./data/incidents/gd2010toPresent.xlsx", sheet = 2)
gt.inc <- read_xlsx("./data/incidents/gtggungs2010toPresent.xlsx", sheet = 2)
```
